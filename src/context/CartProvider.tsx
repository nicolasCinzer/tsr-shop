...
const reducer = (state: CartStateType, action: ReducerAction): CartStateType => {
  switch (action.type) {
    ...
    case REDUCER_ACTION_TYPE.QTY: {
      if (!action.payload) {
        throw new Error('Payload missing in QTY action.')
      }
...
const useCartContext = (initCartState: CartStateType) => {
  ...
  // Esto va causar que no se vuelva a definir las acciones del reducer cada ver que el reducer causa un re-render
